        ...
        <div className="w-1/2 max-lg:w-full flex flex-col gap-[16px] max-lg:items-center">
            ...
            { label: "Politica de privacidade", path: "/politica-de-privacidade" }
                ...
                <div className="flex flex-row-wrap mt-6 gap-[24px] flex-wrap">
                    <CTAButton children="Fazer login" href={"login"} className=""/>
                    <CTAButton children="Cadastre-se" href={"register"} className=""/>
                </div>
        </div>

        <div className="w-1/2 max-lg:w-full gap-[24px] flex flex-col items-end max-lg:items-center">
            <h2 className="mb-6">Redes Sociais</h2>
            <SocialButton href="https://www.instagram.com/dev_gabrielflorentino/" children="@Gabriel-florentino" SVG={<TiSocialInstagram className="size-10"/>}/>
            <SocialButton href="https://github.com/gabriel-florentino" children="@Gabriel-florentino" SVG={<TiSocialGithub  className="size-10"/>}/>
            <SocialButton href="https://www.linkedin.com/in/gabriel-florentino/" children="@Gabriel-florentino" SVG={<TiSocialLinkedin   className="size-10"/>}/>
                <div className="border-2 border-black rounded-3xl p-6 gao-[16px]
                dark:border-white mt-6">
                    ...
                    <p>Porque ninguém deve implorar por oportunidade.</p>
                    <p>Porque o mercado precisa enxergar além do currículo.</p>
                </div>
        </div>
      </div>
