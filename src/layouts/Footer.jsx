...
function Header() {
  ...
  return (
    <footer className="flex flex-col w-full max-w-5xl dark:text-white gap-[80px]">
      <div className="flex flex-row max-lg:flex-col  justify-between w-full gap-[80px]">
        <div className="w-1/2 max-lg:w-full flex flex-col gap-[16px] max-lg:items-center">
            <h2>Mapa do site</h2>
            ...
            ]} className="mt-6 flex-col max-lg:items-center"/>
                <div className="flex flex-row-wrap mt-6 gap-[24px] flex-wrap">
                    <CTAButton ariaLabel="Botao para chegar a pagina de login" children="Fazer login" href={"login"} className=""/>
                    <CTAButton ariaLabel="Botao para chegar a pagina de cedastro" children="Cadastre-se" href={"register"} className=""/>
                </div>
        </div>

        <div className="w-1/2 max-lg:w-full gap-[24px] flex flex-col items-end max-lg:items-center">
            <h2 className="mb-6">Redes Sociais</h2>
            <SocialButton ariaLabel="Botao para acessar o instagram" href="https://www.instagram.com/dev_gabrielflorentino/" children="@Gabriel-florentino" SVG={<TiSocialInstagram className="size-10"/>}/>
            <SocialButton ariaLabel="Botao para acessar o github" href="https://github.com/gabriel-florentino" children="@Gabriel-florentino" SVG={<TiSocialGithub  className="size-10"/>}/>
            <SocialButton ariaLabel="Botao para acessar o linkedin" href="https://www.linkedin.com/in/gabriel-florentino/" children="@Gabriel-florentino" SVG={<TiSocialLinkedin   className="size-10"/>}/>
                <div className="border-2 border-black rounded-3xl py-2 px-4 gao-[16px]
                dark:border-white mt-6">
                    <Link to="/">
                        <svg className="w-32 h-12 fill-black dark:fill-white" xmlns="http://www.w3.org/2000/svg" width="78" height="13" viewBox="0 0 78 13" fill="none">
                    ...
                    <p>Porque o mercado precisa enxergar além.</p>
                </div>
        </div>
      </div>
      <div className="p-4 place-items-center text-center">
        <p>Desenvolvido por Gabriel Florentino. &copy; Todos os créditos estão no README no github</p>
      </div>
    </footer>
  )
}
